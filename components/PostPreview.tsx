            ...
            <Link href={`/posts/${props.slug}`} className='flex flex-col h-full w-full'>
                <div className='relative flex-1'>
                    {props.image == "" || props.image == undefined
                        ...
                        : <ExportedImage height={192} width={414} src={props.image} loading="lazy" alt={props.title}  className="w-full h-48 rounded-t-md bg-gray-100 text-gray-100 dark:bg-gray-600 dark:text-gray-600 object-cover" />
                    }
