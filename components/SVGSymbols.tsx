    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
            ...
            <symbol id="icon-file" viewBox="0 0 512 512">
                <path
                    d="M412 152h-60c-8.8 0-16-7.2-16-16V76c0-8.8-7.2-16-16-16H120c-22.1 0-40 17.9-40 40v312c0 22.1 17.9 40 40 40h272c22.1 0 40-17.9 40-40V168c0-8.8-7.2-16-16-16z"
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                ></path>
                <path
                    d="M416 160h-80a16 16 0 0 1-16-16V64"
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
